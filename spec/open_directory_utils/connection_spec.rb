...
RSpec.describe OpenDirectoryUtils::Connection do
  ...
  context "server paramters are correct" do
    ...
    it "pwpolicy command path overrides from params" do
      ...
      expect(od.od_info[:pwpolicy]).to eq('pwpolicy')
    end
  end
